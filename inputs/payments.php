...
<head>
	...
	<title>Input Payments | Shopix</title>
</head>
<body>
	<div class="container">
		<div class="navbar">
		...
		<div class="input-form">
			...
			<p>
				<?php
					echo "Connection to database successful. <br> Instance added to 'Payments' table: <br> " . $payment_amount . "<br>" . $payment_date . "<br>";

					$sql = "INSERT INTO Payments (amount, p_date) VALUES (" . $payment_amount . ", CAST('" . $payment_date . "' AS DATE))";
			...
			<a href="paymentsall.php">View full table</a>
		</div>
	</div>
</body>
</html>
