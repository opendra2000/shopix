...
<head>
	...
	<title>Input Workers | Shopix</title>
</head>
<body>
	<div class="container">
		<div class="navbar">
		...
		<div class="input-form">
			...
			<p>
				<?php
					echo "Connection to database successful. <br> Instance added to 'Workers' table: " . $worker_name . "<br>" . $worker_position . "<br>";

					$sql = "INSERT INTO Workers (name, position) VALUES ('" . $worker_name . "', '" . $worker_position . "')";
			...
			<a href="workersall.php">View full table</a>
		</div>
	</div>
</body>
</html>
